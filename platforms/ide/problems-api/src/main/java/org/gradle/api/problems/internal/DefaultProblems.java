...
public class DefaultProblems implements InternalProblems {
    ...
    public DefaultProblems(ProblemSummarizer problemSummarizer, ProblemStream problemStream, CurrentBuildOperationRef currentBuildOperationRef, ExceptionProblemContainer exceptionProblemContainer, ExceptionAnalyser exceptionAnalyser) {
        this.problemSummarizer = problemSummarizer;
        this.problemStream = problemStream;
        this.currentBuildOperationRef = currentBuildOperationRef;
        this.exceptionProblemContainer = exceptionProblemContainer;
    ...
    private DefaultProblemReporter createReporter() {
        return new DefaultProblemReporter(problemSummarizer, problemStream, currentBuildOperationRef, additionalDataBuilderFactory, exceptionProblemContainer, exceptionAnalyser);
    }
