...
class DefaultProblemTest extends Specification {
    ...
    def "unbound builder result with a change and check report"() {
        ...
        def problemReporter = new DefaultProblemReporter(emitter, null, CurrentBuildOperationRef.instance(), new AdditionalDataBuilderFactory(), new ExceptionProblemContainer(), null)
