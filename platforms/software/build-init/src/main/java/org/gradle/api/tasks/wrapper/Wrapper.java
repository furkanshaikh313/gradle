...
////    @ToBeReplacedByLazyProperty(comment = "Not supported yet", issue = "https://github.com/gradle/gradle/issues/29341")
//    @ReplacesEagerProperty
//    public ListProperty<DistributionType> getAvailableDistributionTypes() {
//        return getObjectFactory().listProperty(DistributionType.class).value(Arrays.asList(DistributionType.values()));
//    }
