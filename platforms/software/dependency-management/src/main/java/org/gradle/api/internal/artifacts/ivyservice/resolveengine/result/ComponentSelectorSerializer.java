...
public class ComponentSelectorSerializer extends AbstractSerializer<ComponentSelector> {
    ...
    public ComponentSelectorSerializer(DeduplicatingAttributeContainerSerializer attributeContainerSerializer, CapabilitySelectorSerializer capabilitySelectorSerializer) {
