...
public class DefaultTransformUpstreamDependenciesResolver implements TransformUpstreamDependenciesResolver {
     ...
     * <p>
     * This is required to calculate the true build dependencies transforms with dependencies, as
     * the incomplete graph used to determine upstream transforms does not represent the final
     * dependency graph.
     * <p>
