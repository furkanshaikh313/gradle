...
public class TestingBuildSessionScopeServices implements ServiceRegistrationProvider {
    ...
    @Provides
    TestEventGeneratorFactory createTestEventService(TestListenerBuildOperationAdapter testListenerBuildOperationAdapter) {
        return new DefaultTestEventGeneratorFactory(testListenerBuildOperationAdapter);
    }
