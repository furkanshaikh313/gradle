...
public class DefaultTestEventGenerator implements TestEventGenerator {
    ...
    protected final @Nullable DefaultCompositeTestEventGenerator parent;
    protected final TestDescriptorInternal testDescriptor;
    private State state = State.CREATED;

    public DefaultTestEventGenerator(
        TestResultProcessor processor, @Nullable DefaultCompositeTestEventGenerator parent, TestDescriptorInternal testDescriptor
    ) {
